              ...
              child: Column(
                children: [
                  ...
                  height: 300,),
                    ...
                    Textformfieldauth(valid: (value ) { return validateinput(value!, 10 , 50); }, mycontroller: controller.email ,hinttext: 'Enter your email', iconData: Icons.email, ),
                    const SizedBox(height: 5,),
                    Textformfieldauth(valid: (value ) {  return validateinput(value!, 8 , 20); }, mycontroller: controller.password,hinttext: 'Enter your password ', iconData: Icons.lock, ),
                    const  SizedBox(height: 20,),
